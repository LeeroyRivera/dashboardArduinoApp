...
namespace dashboardArduinoApp.Clases
{
    static class SensorGas
    {
        ...
        {
            string query = "select FechaHora, Gas from registros order by FechaHora desc limit 1;";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Registro = (double)Convert.ToDecimal(dt.Rows[0]["Gas"].ToString());
            }
        }
    }
}
