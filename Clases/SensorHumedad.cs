...
namespace dashboardArduinoApp.Clases
{
    static class SensorHumedad
    {
        ...
        {
            string query = "select FechaHora, Humedad from registros order by FechaHora desc limit 1;";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Registro = (double)Convert.ToDecimal(dt.Rows[0]["Humedad"].ToString());
            }
        }
    }
}
