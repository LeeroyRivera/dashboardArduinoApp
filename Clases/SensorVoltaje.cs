...
namespace dashboardArduinoApp.Clases
{
    static class SensorVoltaje
    {
        ...
        {
            string query = "select FechaHora, Voltaje from registros order by FechaHora desc limit 1;";
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                Registro = (double)Convert.ToDecimal(dt.Rows[0]["Voltaje"].ToString());
            }
        }
    }
}
